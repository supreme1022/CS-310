...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "yaml-cpp-0.7.0"
  WORKING_DIRECTORY "/workspaces/CS-310/Lab1.2/build/_deps/yaml-cpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/CS-310/Lab1.2/build/_deps/yaml-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/CS-310/Lab1.2/build/_deps/yaml-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
